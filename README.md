...
efficiency of Matrix Multiplication (MatMul) applications on Versal AIEs. The main contributions are:
...
3. Optimization of `M`, `K`, `N` and `X`, `Y`, `Z` parameters as shown at Section IV-C.
